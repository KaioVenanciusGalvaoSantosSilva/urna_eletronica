            ...
            <tbody>
                <?php foreach ($candidatos as $candidato): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($candidato['nome_vice'], ENT_QUOTES, 'UTF-8'); ?></td>
                        <td><img src="<?php echo htmlspecialchars($candidato['foto_vice'], ENT_QUOTES, 'UTF-8'); ?>" alt="Foto do Vice" class="foto-candidato"></td>
                        <td><?php echo $candidato['votos']; ?></td>
                        <td><?php echo calcularPorcentagem($candidato['votos'], $totalVotos); ?>%</td>
                    </tr>
                <?php endforeach; ?>
                <tr>
                    <td colspan="5"><strong>Votos Brancos</strong></td>
                    <td><?php echo $votosBrancos; ?></td>
                    <td><?php echo calcularPorcentagem($votosBrancos, $totalVotos); ?>%</td>
                </tr>
                <tr>
                    <td colspan="5"><strong>Votos Nulos</strong></td>
